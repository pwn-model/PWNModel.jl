...
@testset "Colonization calc_arrivals! conserves beetle count" begin
    ...
    s = PWNModel.Colonization(
        tick_of_year=0, cell_size=10, kernel_radius=1, kernel_half_distance=log(2),
...
@testset "Colonization calc_probability! occupancy formula" begin
    ...
    s = PWNModel.Colonization(
        tick_of_year=0, cell_size=10, kernel_radius=0, kernel_half_distance=log(2),
...
@testset "Colonization skips wrong tick of year" begin
    ...
    s = PWNModel.Colonization(
        tick_of_year=5, cell_size=100, kernel_radius=0, kernel_half_distance=log(2),
...
@testset "Colonization colonizes susceptible tree when beetles arrive" begin
    ...
    s = PWNModel.Colonization(
        tick_of_year=3, cell_size=100, kernel_radius=0, kernel_half_distance=log(2),
...
@testset "Colonization no colonization without source" begin
    ...
    s = PWNModel.Colonization(
        tick_of_year=3, cell_size=100, kernel_radius=2, kernel_half_distance=log(2),
